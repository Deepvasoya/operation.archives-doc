...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a href="{{ url('/') }}" class="app-brand-link">
      ...
      <span class="app-brand-logo demo"><img src="{{ asset('assets/img/custom/logo.png') }}" alt="Logo"
          width="100"></span>
      {{-- <span class="app-brand-text demo menu-text fw-bold ms-2">Système de gestion de la banque</span> --}}
    </a>
